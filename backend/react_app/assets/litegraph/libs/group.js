...
SubgraphInput.title = "输入";
SubgraphInput.desc = "Input of the graph";

SubgraphInput.prototype.onConfigure = function () {
    this.updateType();
}

//ensures the type in the node output and the type in the associated graph input are the same
SubgraphInput.prototype.updateType = function () {
...
SubgraphInput.prototype.onPropertyChanged = function (name, v) {
    if (name == "name") {
...
SubgraphInput.prototype.getTitle = function () {
    if (this.flags.collapsed) {
...
SubgraphInput.prototype.onAction = function (action, param) {
    if (this.properties.type == LiteGraph.EVENT) {
        this.triggerSlot(0, param);
    }
};

SubgraphInput.prototype.onExecute = function () {
...
SubgraphInput.prototype.onRemoved = function () {
    if (this.name_in_graph) {
...
SubgraphOutput.title = "输出";
SubgraphOutput.desc = "Output of the graph";

SubgraphOutput.prototype.onPropertyChanged = function (name, v) {
    if (name == "name") {
        if (v == "" || v == this.name_in_graph || v == "enabled") {
            return false;
        }
...
SubgraphOutput.prototype.updateType = function () {
    var type = this.properties.type;
    if (this.type_widget)
        this.type_widget.value = type;
...
SubgraphOutput.prototype.onExecute = function () {
    this._value = this.getInputData(0);
    this.graph.setOutputData(this.properties.name, this._value);
};

SubgraphOutput.prototype.onAction = function (action, param) {
    if (this.properties.type == LiteGraph.ACTION) {
        this.graph.trigger(this.properties.name, param);
    }
};

SubgraphOutput.prototype.onRemoved = function () {
    if (this.name_in_graph) {
        this.graph.removeOutput(this.name_in_graph);
    }
};

SubgraphOutput.prototype.getTitle = function () {
    if (this.flags.collapsed) {
        return this.properties.name;
    }
    return this.title;
